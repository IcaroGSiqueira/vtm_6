/* 
 * File:   RetiradorDeInformacoes
RetiradorDeInformacoes.h
 * Author: grellert
 *
...
public:
    ...
    static void getSADSSE( TComYuv *pcYuvSrc0,int width);
